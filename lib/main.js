...
var gnanmeanors = require( '@stdlib/stats-base-ndarray-nanmeanors' );
var dnanmeanors = require( '@stdlib/stats-base-ndarray-dnanmeanors' );
var snanmeanors = require( '@stdlib/stats-base-ndarray-snanmeanors' );
...
*
* // Perform reduction:
* var out = nanmeanors( x );
* // returns <ndarray>
*
* var v = out.get();
* // returns 7.2
*/
var nanmeanors = factory( table, [ idtypes ], odtypes, policies );
