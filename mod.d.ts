...
interface Unary {
	...
	*/
	...
	/**
	* Computes the arithmetic mean along one or more ndarray dimensions, ignoring `NaN` values and using ordinary recursive summation, and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
...
* // returns true
*/
declare const nanmeanors: Unary;
